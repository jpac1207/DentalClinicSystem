...
namespace HealthSolution.Controllers
{
    ...
    public class PacienteViewModelController : Controller
    {
        ...
        private PacienteViewModel GetPacienteViewModel(Paciente x)
        {
            ...
            var myCellPhone = db.Telefones.Where(y => y.Id == x.CelularId).FirstOrDefault();
            ...
            pacienteViewModel.Email = x.Email;
            pacienteViewModel.NumeroCarteiraPlano = x.NumeroCarteiraPlano;
            ...
            if(myCellPhone != null)
            {
                pacienteViewModel.NumeroCelular = myCellPhone.Numero;
            }
        ...
        public ActionResult ExportAll([Form] QueryOptions queryOptions, string nome, string cpf)
        {
            try
            {
                var pacientesViewModel = new List<PacienteViewModel>();
                ...
                StringWriter sw = new StringWriter();
                HtmlTextWriter htw = new HtmlTextWriter(sw);
                string fileName = "Export_Pacientes_Completo_" + DateTime.Now.ToString("dd.MM.yyyy") + ".xls";
        ...
        public void AddPacientCellphone()
        {

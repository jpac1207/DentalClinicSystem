...
namespace HealthSolution.Controllers
{
    ...
    public class ConsultaViewModelController : Controller
    {
        ...
        private ConsultaViewModel GetConsultaViewModel(Consulta x)
        {
            ...
            consultaViewModel.Tratamento = x.Tratamento;
        ...
        public ActionResult ExportAll([Form] QueryOptions queryOptions, string doutor, string paciente, string especialidade, string data)
        {
            try
            {
                var consultasViewModels = new List<ConsultaViewModel>();
                ...
                StringWriter sw = new StringWriter();
                HtmlTextWriter htw = new HtmlTextWriter(sw);
                string fileName = "Export_Consultas_Completo_" + DateTime.Now.ToString("dd.MM.yyyy") + ".xls";
